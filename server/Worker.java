...
public class Worker implements Runnable {
    ...
    // public static synchronized void checkRequestVerb(Socket client, String method, String resource) throws IOException {
    //     // * Switch on method
    //     switch (method) {
    //         case "GET":
    //             getRequest(client, resource);
    ...
    //             // String fifthLine = reqArr[4];
    //             // String sixthLine = reqArr[5];
    //             putRequest(client, resource, fifthLine, sixthLine);
    //             break;
    //         case "DELETE":
    //             deleteRequest(client, resource);
    //             break;
