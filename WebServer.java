...
public class WebServer {
  ...
  private static HashMap<String,ArrayList<String>> configMap;
  ...
  public WebServer() {
    ...
    System.out.println(configMap.get("Listen"));
    // port = Integer.parseInt(configMap.get("Listen").get(0).toString());
  }
